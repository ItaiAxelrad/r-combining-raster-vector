...
download.file(url = 'https://raw.githubusercontent.com/fyousef/UCLA-remote-sensing/master/Data/Lab4/wageningenWater.zip', destfile = 'wageningenWater.zip', method = 'auto')
